...
It is safe to say that every software company faces the problem of increasing technical debt. It is easy for developers to dismiss the duty for paying up technical debt, and it's quite convenient for developers to just "forget" that such thing even exists. That is until it grows so big that it can no longer be ignored. When this happens, old people quitting and leaving the debt for newcomers to deal with may become a tempting option. For the company though, the situation can be paralyzing, and therefore, technical debt should be properly managed and not be forgotten or postponed indefinitely.

### 3.0 Knowledge Sharing and Mitigating the Risks of Key Person Dependencies
...
##### 3.1 The Importance of Self-Documenting Code
...
### 4.0 The Debate Between "Over-Engineering" and "Under-Engineering"
...
##### 4.2 Ever-changing Business Environments
